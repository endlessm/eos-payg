                       ...
                       gconstpointer data)
{
  ...
  ret = epg_provider_add_code (fixture->provider, "00000000", &time_added, &error);
  g_assert_error (error, EPG_MANAGER_ERROR, EPG_MANAGER_ERROR_DISABLED);
  g_assert_false (ret);
  g_assert_cmpuint (0, ==, time_added);
  g_clear_error (&error);
                                ...
                                gconstpointer data)
{
  ...
  g_assert_cmpint (G_MAXINT64, ==, time_added);
